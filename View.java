...
class View {
    ...
    View(DefaultTableModel processTableModel, DefaultTableModel accTableModel, KeyListener keyListener, Controller controller) {
        ...
        avgTATLabel = new JLabel("Average Turn Around Time: 0.00");
        ...
        statsPanel.add(Box.createHorizontalStrut(20)); // Add some spacing
    ...
    void updateAccTable(Model model) {
        ...
        avgTATLabel.setText(String.format("Average Turn Around Time: %.2f", avgTAT));
