...
public class Controller implements KeyListener {
    ...
    public void nonPre(String algo) {
        ...
        while (checkLeftBT()) {
            ...
            if (algo.equals("sjf"))
                queue.sort(Comparator.comparingInt((Integer q) -> model.getProcess(q).getBT())
                                     .thenComparingInt(q -> model.getProcess(q).getAT()));

            else
                queue.sort(Comparator.comparingInt((Integer q) -> model.getProcess(q).getpriority())
                                     .thenComparingInt(q -> model.getProcess(q).getAT()));
